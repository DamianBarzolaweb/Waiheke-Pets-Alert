...
- **Compartir en Facebook:** en cada alerta, botones para abrir el diálogo de compartir (preview OG) y el grupo [Waiheke Lost & Found Pets](https://www.facebook.com/groups/waihekelostandfoundpets/). No importa posts del grupo automáticamente (límites de Meta). `WPA_FACEBOOK_GROUP_URL` en Heroku para otro grupo.
